...
const zh: Dict = {
  ...
  'spot.customSpot': '自建地点',
  'spot.name': '地点名称',
  'spot.description': '描述',
  'spot.photo': '照片',
  'spot.uploadPhoto': '选择照片',
  'spot.noPhoto': '未选择照片',
  'spot.addSpot': '添加地点',
  'spot.addTitle': '添加想去的店/打卡点',
  'spot.added': '已添加「{name}」',
  'spot.nameRequired': '请输入地点名。',
  'spot.uploadFailed': '照片上传失败，已保存文字信息',
  'spot.deleteSpot': '删除地点',
  'spot.dragHint': '拖动标记可调整位置',
  'spot.wrongPhotoType': '请选择图片文件。',
...
const ja: Dict = {
  ...
  'spot.customSpot': 'カスタムスポット',
  'spot.name': 'スポット名',
  'spot.description': '説明',
  'spot.photo': '写真',
  'spot.uploadPhoto': '写真を選択',
  'spot.noPhoto': '写真未選択',
  'spot.addSpot': 'スポットを追加',
  'spot.addTitle': '行きたい店/スポットを追加',
  'spot.added': '「{name}」を追加しました',
  'spot.nameRequired': 'スポット名を入力してください。',
  'spot.uploadFailed': '写真のアップロードに失敗しました。テキスト情報を保存しました',
  'spot.deleteSpot': 'スポットを削除',
  'spot.dragHint': 'マーカーをドラッグで位置調整',
  'spot.wrongPhotoType': '画像ファイルを選択してください。',
